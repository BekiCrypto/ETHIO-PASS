          ...
          <div className="container px-4 md:px-6">
            <div className="flex flex-col items-center space-y-4">
              ...
              <p className="mx-auto max-w-[700px] text-muted-foreground md:text-xl">
                Ethio Pass is Ethiopia's national digital identity platform, providing citizens and residents with secure and seamless access to government and private services.
              </p>
